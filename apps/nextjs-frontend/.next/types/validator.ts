...
// Validate ../../src/app/[locale]/reports/[reportType]/download/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/[locale]/reports/[reportType]/download">> = Specific
  const handler = {} as typeof import("../../src/app/[locale]/reports/[reportType]/download/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
